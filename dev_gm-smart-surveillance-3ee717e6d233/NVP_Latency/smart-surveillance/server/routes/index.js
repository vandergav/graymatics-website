module.exports = function(app) {
	...
	app.get('/notification/latest', notification);
	app.get('/notification/count/:type', notification);
	app.get('/notification/action/count/:type', notification);
	app.get('/camera/notifications/:user_id/:camera_id', notification);
	app.get('/notification/:_id', notification);
	...
	app.get('/basic_notification/count/:user_id/:type', basic_notification);
	app.get('/basic_notification/action/count/:user_id/:type', basic_notification);
