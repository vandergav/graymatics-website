...
router.get('/basic_notification/count/:user_id/:type/:media_type', function(req, res, next) {
...
/* Get todays notification count */
router.get('/basic_notification/action/count/:user_id/:type/:media_type', function(req, res, next) {
