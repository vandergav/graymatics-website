...
export class ROIComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    .subscribe(params => {
        ...
        this.subscription_list = params['algos'];
                      ...
                      .subscribe(
                        data => {
                          ...
                          if(this.response.status == 'error'){
                            ...
                            if( this.subscription_list.indexOf('person_tracking') || this.subscription_list.indexOf("FACE_RECOGNITION") )
                              // this.router.navigate(['/supervisor/people-list']);
                              this.router.navigate(['/home']);
                            else if( this.subscription_list.indexOf('vehicle_tracking') )
                              // this.router.navigate(['/supervisor/people-list']);
                              this.router.navigate(['/home']);
                            else
