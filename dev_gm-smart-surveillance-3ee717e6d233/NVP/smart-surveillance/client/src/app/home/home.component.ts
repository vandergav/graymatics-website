            ...
            .subscribe(
                data => {
                    ...
                    if(this.response.status == 'error'){
                        ...
                        */
                       // yellow notiifcation count for today
                       this.notificationService.count('speed_detection','camera')
                            .subscribe(
                                data => {
                                    this.yellow_count = data ;
                                },
                        ...
                        // yewllow notiifcation action count for today
                        this.notificationService.action_count('speed_detection','camera')
                            .subscribe(
                                data => {
                                    this.yellow_action_count = data ;
                                },
                        ...
                        this.notificationService.count('congestion_detection','camera')
                         .subscribe(
                             data => {
                                 this.red_count = data ;
                             },
                        ...
                        // red notiifcation action count for today
                        this.notificationService.action_count('congestion_detection','camera')
                         .subscribe(
                             data => {
                                 this.red_action_count = data ;
                             },
                            ...
                            .subscribe(
                                data => {
                                    ...
                                    for(var l in this.latest_notification) {
                                        ...
                                        if(this.latest_notification[l].type == 'congestion_detection') {
                                        ...
                                        if(this.latest_notification[l].type == 'speed_detection') {
                        ...
                        .subscribe(message => {
                            ...
                            if(this.message.notification_type == 'congestion_detection'){
                            ...
                            if(this.message.notification_type == 'speed_detection'){
                                // Activate yellow notification section
                                this.green = false;
                                this.red = false;
                                this.yellow = true;
