            ...
            .subscribe(
                data => {
                    ...
                    if(this.response.status == 'error'){
                        ...
                        localStorage.setItem('currentUser', JSON.stringify(this.response.user.username));
                        localStorage.setItem('user_id', JSON.stringify(this.response.user.user_id));
                    ...
                    if(this.response.user.username == 'superviser')
