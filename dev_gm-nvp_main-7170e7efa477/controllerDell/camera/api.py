...
class CameraHandler(tornado.web.RequestHandler):
	...
	def put(self):
		...
		request_call("http://127.0.0.1:8080/algo/", data=data, method="POST")
	...
	def delete(self):
		...
		response = request_call("http://127.0.0.1:8080/algo/", data=data, method="DELETE")
	...
	def patch(self):
		...
		request_call("http://127.0.0.1:8080/algo/", data=data, method="PATCH")
		self.write(json.dumps({"status":True}))
