module.exports = function(app) {
	...
	app.get('/face_recognition_list/:user_id', face_recognition);
	app.get('/face_recognition_details/:user_id/:source', face_recognition);
	app.post('/face_recognition', face_recognition);
	app.put('/face_recognition', face_recognition);

	//face_training api
	var face_training = require('./face_training');
	app.get('/face_training/:user_id/:_id', face_training);
	app.get('/face_list/:user_id', face_training);
	app.post('/face_training', face_training);
	app.put('/face_training', face_training);

	//vehicle_recognition api
	var vehicle_recognition = require('./vehicle_recognition');
	app.get('/vehicle_recognition/list_name/:user_id/:list_name', vehicle_recognition);
	app.get('/vehicle_recognition_list/:user_id', vehicle_recognition);
	app.post('/vehicle_recognition', vehicle_recognition);
	app.put('/vehicle_recognition', vehicle_recognition);
	app.delete('/vehicle_recognition/:list_id', vehicle_recognition);
	

	//user_list routes
	var user_list = require('./user_list');
	app.post('/configuration/user_list', user_list);
	app.put('/configuration/user_list', user_list);
	app.get('/configuration/user_list', user_list);
	app.delete('/configuration/user_list/:_id', user_list);
	...
	app.delete('/configuration/notification/:_id', configuration);
