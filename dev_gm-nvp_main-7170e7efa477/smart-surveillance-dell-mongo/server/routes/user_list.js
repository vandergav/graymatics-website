...
/* Create Contact */
router.post('/configuration/user_list', function(req, res, next) {
...
/* Update Contact */
router.put('/configuration/user_list', function(req, res, next) {
...
router.get('/configuration/user_list', function(req, res, next) {
...
router.delete('/configuration/user_list/:_id', function(req, res, next) {
