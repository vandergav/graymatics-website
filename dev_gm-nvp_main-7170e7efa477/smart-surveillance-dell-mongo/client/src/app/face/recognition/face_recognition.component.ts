...
@Component({
    ...
    templateUrl: 'face_recognition.component.html',
    providers: [Modal]
})
...
export class FaceRecognitionComponent implements OnInit {
     ...
     */
    faceList() {
        this.faceService.list_face_recognition(localStorage.getItem('user_id'))
        .subscribe(
            data => {
                this.response4 = data;
    ...
    faceView(face:any) {
        this.router.navigate(['/face/recognition/add'],{ queryParams: { face_id : face._id , subject_type : face.subject_type, name : face.name , age : face.age , gender : face.gender , ethnicity : face.ethnicity  } });
    }
