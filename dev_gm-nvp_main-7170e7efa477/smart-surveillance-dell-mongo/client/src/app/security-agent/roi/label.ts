...
var getMousePos = function (_canvas:any, evt:any) {
...
var mouseXY = function (evt:any, canvas:any, curve:any) {
...
var mouseDown = function (evt:any, canvas:any, curve:any) {
  if (evt.buttons == 1) {
...
function drawImage(image_src: string, ctx:any, height:any, width:any) {
  let image = new Image();
  image.src = image_src;
