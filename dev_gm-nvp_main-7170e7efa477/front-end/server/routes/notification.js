...
router.get('/notification/latest/:user_id/:media_type', function(req, res, next) {
...
/* Get Notification */
router.get('/notification/:scene_id/:media_type', function(req, res, next) {
	logger.info("Route: /notification/select:");
	logger.info("Parameters : req.params: " + JSON.stringify(req.params));
...
router.get('/camera/notifications/:user_id/:camera_id/:media_type', function(req, res, next) {
...
/* Search results */
router.get('/search/:user_id/:pageno/:keyword/:media_type', function(req, res, next) {
	logger.info("Route: /notification/search:");
	logger.info("Parameters : req.params: " + JSON.stringify(req.params));

	next();

}, notification.getSearchResults);

/* Search results */
router.get('/search_total_count/:user_id/:pageno/:keyword/:media_type', function(req, res, next) {
	logger.info("Route: /notification/search:");
	logger.info("Parameters : req.params: " + JSON.stringify(req.params));

	next();

}, notification.getSearchCountResult);

/* Search Filter total count*/
router.get('/search_filter_total_count/:user_id/:camera_name/:time/:media_type', function(req, res, next) {
	logger.info("Route: /notification/search_filter_total_count:");
	logger.info("Parameters : req.params: " + JSON.stringify(req.params));

	next();

}, notification.getSearchFilterCountResults);

/* Search Filter */
router.get('/search_filter/:user_id/:camera_name/:time/:pageno/:media_type', function(req, res, next) {
	logger.info("Route: /notification/search_filter:");
	logger.info("Parameters : req.params: " + JSON.stringify(req.params));

	next();

}, notification.getSearchFilterResults);
