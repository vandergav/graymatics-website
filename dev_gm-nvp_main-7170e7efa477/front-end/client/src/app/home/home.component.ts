...
export class HomeComponent implements OnInit {
    ...
    // toggle button 
    fullScreen(event: Event,camera_id: string,camera_name: string){
        event.preventDefault();
        this.isBig = !this.isBig;
        this.isSmall = !this.isSmall;
        this.full_screen_cam_id = camera_id;
        this.full_screen_cam_name = camera_name;
    }
    security_cam_view(camera_id: number){
        this.router.navigate(['/security/camera/view'],{ queryParams: { camera_id : camera_id } });
    }
    ...
    reset_camera(cam:any){
        ...
        this.notificationService.remove(cam.camera_id)
            .subscribe(
            data => {
                ...
                data => {
                    ...
                    if(this.response.status == 'error'){
                        ...
                        for(var s=0; s < this.cams.length ; s++){
                            ...
                            this.startCamera.camera_id = this.cams[s].camera_id;
