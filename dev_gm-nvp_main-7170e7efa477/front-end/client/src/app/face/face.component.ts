...
export class FaceComponent implements OnInit {
    ...
    faceView(face:any) {
        this.router.navigate(['/face/add'],{ queryParams: { face_id : face._id , subject_type : face.subject_type, name : face.name , age : face.age , gender : face.gender , ethnicity : face.ethnicity  } });
    }
