...
export class SingleCameraViewComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        .subscribe(params => {
            ...
            this.viewCamNotificatations(params['camera_id'],params['user_id']);
        });    
    }
    ...
    viewCamNotificatations(camera_id:number,user_id:number) {
        // Get camera details
        ...
        this.notificationService.getCamNotifications(camera_id,'camera')
            .subscribe(
                data => {
                    this.response4 = data;
